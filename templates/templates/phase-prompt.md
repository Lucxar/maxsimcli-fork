...
See `~/.claude/maxsim/references/tdd.md` for TDD plan structure.
...
See `~/.claude/maxsim/templates/user-setup.md` for full schema and examples
...
See `~/.claude/maxsim/workflows/verify-phase.md` for verification logic.
